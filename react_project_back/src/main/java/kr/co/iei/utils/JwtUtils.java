...
public class JwtUtils {
	...
	@org.springframework.beans.factory.annotation.Value("${jwt.secret-key}") //The annotation @Bean is disallowed for this location
	//-> bean을 쓸 수 없는 위치에 썼다는 말 
	private String secretKey;

	@org.springframework.beans.factory.annotation.Value("${jwt.expire-hour}")
